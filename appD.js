    ...
    userInfo = document.getElementById("datad"),
...
let userd = localStorage.getItem('userd') ? JSON.parse(localStorage.getItem('userd')) : []
...
form.addEventListener('submit', (e)=> {
    ...
    if(!isEdit){
        userd.push(information)
    }
    else{
        isEdit = false
        userd[editId] = information
    }
